...
- For navigate, params = { path: "/cases", search: "optional exact filter" }. When the user asks to find/search/list filtered artifacts, include the shortest useful filter in search (for example "@UI" for cases tagged @UI).
